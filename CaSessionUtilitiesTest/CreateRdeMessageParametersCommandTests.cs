...
public class CreateRdeMessageParametersCommandTests
{
    ...
    private const string HexEncodedPublicKey = "";
    private const string PublicKeyOid = "0.4.0.127.0.7.2.2.1.2";
    private const string CaProtocolOid = ChipAuthenticationInfo.ID_CA_ECDH_AES_CBC_CMAC_256;
    ...
    private void Write()
    {
        ...
        //Sanity check
        PublicKeyFactory.CreateKey(Hex.Decode(HexEncodedPublicKey));
        ...
        var args = new RdeMessageCreateArgs
        {
            CaSessionArgs = new CaSessionArgs
            {
                ...
                {
                    //KeyId = ,
                    PublicKey = Hex.Decode(HexEncodedPublicKey),
                    // ProtocolOid = ,
                }
            },
        ...
        Trace.WriteLine(">>>>");
        Trace.WriteLine("Z        : " + Hex.ToHexString(actual.EphemeralPublicKey));
        Trace.WriteLine("Command  : " + Hex.ToHexString(actual.WrappedCommand));
        Trace.WriteLine("Response : " + Hex.ToHexString(actual.WrappedResponse));
